# TC002 / prescription.jpeg (primary)
...
| `output_fixture` | fixtures/TC002/prescription.jpeg |
| `quality` | GOOD |
| `variant` | primary |
...
Capture: Clear indoor smartphone photo. Paper fills the frame, sharp focus, slight natural shadow.
