# TC005 / F009_multilingual.jpeg (overlay: multilingual)
...
| `file_id` | F009 |
| `file_name` | F009_multilingual.jpeg |
| `output_fixture` | fixtures/TC005/F009_multilingual.jpeg |
| `quality` | HANDWRITTEN |
| `style_overlay` | multilingual |
| `variant` | multilingual |
| `variant_of` | F009.jpeg |
...
Additional overlay: Overlay: some fields include regional Indian language script alongside English — e.g. patient name or diagnosis also written in Hindi/Telugu/Tamil next to the English text.
