# TC008 / F016_corrections.jpeg (overlay: corrections)
...
| `file_id` | F016 |
| `file_name` | F016_corrections.jpeg |
| `output_fixture` | fixtures/TC008/F016_corrections.jpeg |
| `quality` | HANDWRITTEN |
| `style_overlay` | corrections |
| `variant` | corrections |
| `variant_of` | F016.jpeg |
...
Additional overlay: Overlay: one or more rupee amounts have been crossed out in pen and rewritten nearby — a cashier corrected the entry by hand; the original figure is still visible but struck through.
