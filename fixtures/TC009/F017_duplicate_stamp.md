# TC009 / F017_duplicate_stamp.jpeg (overlay: duplicate_stamp)
...
| `file_id` | F017 |
| `file_name` | F017_duplicate_stamp.jpeg |
| `output_fixture` | fixtures/TC009/F017_duplicate_stamp.jpeg |
| `quality` | HANDWRITTEN |
| `style_overlay` | duplicate_stamp |
| `variant` | duplicate_stamp |
| `variant_of` | F017.jpeg |
...
Additional overlay: Overlay: a large rubber stamp reading 'ORIGINAL' or 'DUPLICATE' appears twice on the document at slightly different angles, one impression partially obscuring text.
